...
Berdasarkan latar belakang penelitian mengenai pentingnya deteksi dini risiko serangan jantung serta pemanfaatan machine learning dalam bidang kesehatan, maka rumusan masalah dalam penelitian ini adalah sebagai berikut:

1. Bagaimana karakteristik data kesehatan pasien yang digunakan dalam memprediksi risiko serangan jantung berdasarkan variabel klinis yang tersedia pada dataset?

2. Bagaimana proses penerapan metode machine learning berbasis klasifikasi dalam memprediksi risiko serangan jantung menggunakan data pasien?

3. Bagaimana perbandingan performa beberapa algoritma klasifikasi machine learning, yaitu Logistic Regression, Random Forest, Decision Tree, K-Nearest Neighbor (KNN), dan Naive Bayes, dalam memprediksi risiko serangan jantung?

4. Algoritma klasifikasi manakah yang memiliki performa terbaik berdasarkan metrik evaluasi seperti akurasi dan recall?

5. Bagaimana implementasi model machine learning terbaik ke dalam aplikasi berbasis web menggunakan Streamlit untuk melakukan prediksi risiko serangan jantung secara interaktif?
...
1. Menganalisis dan memahami karakteristik data kesehatan pasien yang digunakan sebagai dasar prediksi risiko serangan jantung.

2. Menerapkan dan membandingkan beberapa algoritma klasifikasi machine learning dalam memprediksi risiko serangan jantung.

3. Mengetahui algoritma klasifikasi yang memiliki performa terbaik dalam memprediksi risiko serangan jantung berdasarkan hasil evaluasi model.

4. Mengimplementasikan model machine learning terbaik ke dalam aplikasi web interaktif berbasis Streamlit.

5. Menyediakan sistem prediksi risiko serangan jantung yang mudah digunakan sebagai alat bantu analisis awal berbasis data.
